...
- Create: `backend/tests/fixtures/deezer_search_artist.json`
- Create: `backend/tests/fixtures/deezer_search_album.json`
- Create: `backend/tests/adapters/test_deezer.py`

- [x] **Step 10.1: Fixtures schreiben**
...
`tests/fixtures/deezer_search_artist.json`:
```json
{
  "data": [
    {
...
`tests/fixtures/deezer_search_album.json`:
```json
{
  "data": [
    {
...
- [x] **Step 10.2: Test — `tests/adapters/test_deezer.py`**
...
- [x] **Step 10.3: Test laufen — FAIL**

```bash
cd backend && pytest tests/adapters/test_deezer.py -v
```

- [x] **Step 10.4: `src/linkhop/adapters/deezer.py` schreiben**
